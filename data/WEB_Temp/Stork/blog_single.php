<?php $pageTitle = 'Blog Post' ; ?>
<?php include 'inc.php' ?>

	<!-- Home -->

	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="<?php echo $img ?>blog_single_background.jpg" data-speed="0.8"></div>
	</div>
				...
				<div class="col-lg-8 offset-lg-2">
					...
					<div class="single_post_text">
						...
						<div class="single_post_quote text-center">
							<div class="quote_image"><img src="<?php echo $img ?>quote.png" alt=""></div>
