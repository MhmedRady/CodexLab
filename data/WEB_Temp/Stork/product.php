		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="<?php echo $img ?>single_4.jpg"><img src="<?php echo $img ?>single_4.jpg" alt=""></li>
						<li data-image="<?php echo $img ?>single_2.jpg"><img src="<?php echo $img ?>single_2.jpg" alt=""></li>
						<li data-image="<?php echo $img ?>single_3.jpg"><img src="<?php echo $img ?>single_3.jpg" alt=""></li>
					</ul>
				</div>

				<!-- Selected Image -->
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="<?php echo $img ?>single_4.jpg" alt=""></div>
				</div>
